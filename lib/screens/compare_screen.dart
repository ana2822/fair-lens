...
class _CompareScreenState extends State<CompareScreen> {
  ...
  Future<void> _pickFile(int slot) async {
    setState(() { _error = null; if (slot == 1) {
      _loading1 = true;
    } else {
      _loading2 = true;
    } });
          ...
          child: Row(children: [
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.06), borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.white.withValues(alpha: 0.1))),
        ...
        if (_error != null)
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: Colors.red.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(10), border: Border.all(color: Colors.red.withValues(alpha: 0.2))),
              child: Row(children: [
          ...
          child: Column(children: [
            ...
            if (_result1 == null || _result2 == null) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF6366F1).withValues(alpha: 0.05), borderRadius: BorderRadius.circular(16), border: Border.all(color: const Color(0xFF6366F1).withValues(alpha: 0.15))),
                child: Column(children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: result != null ? color.withValues(alpha: 0.06) : const Color(0xFF0D0D1A),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: result != null ? color.withValues(alpha: 0.4) : color.withValues(alpha: 0.2), width: result != null ? 1.5 : 1),
        ),
        child: loading
          ...
          : result == null
            ...
            : Column(children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: _scoreColor(result.overallBiasScore).withValues(alpha: 0.12), borderRadius: BorderRadius.circular(6)),
                ...
                GestureDetector(onTap: () => _pickFile(slot),
                  child: Text('Change', style: GoogleFonts.spaceGrotesk(color: color.withValues(alpha: 0.6), fontSize: 11, decoration: TextDecoration.underline))),
              ]),
      ),
    );
  }
  ...
  Widget _buildComparison(AnalysisReport r1, AnalysisReport r2) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: improved
            ? [const Color(0xFF10B981).withValues(alpha: 0.12), const Color(0xFF080810)]
            : [const Color(0xFFEF4444).withValues(alpha: 0.08), const Color(0xFF080810)]),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: improved ? const Color(0xFF10B981).withValues(alpha: 0.3) : const Color(0xFFEF4444).withValues(alpha: 0.2)),
        ),
        child: Column(children: [
      ...
      SizedBox(height: 180, child: BarChart(BarChartData(
        ...
        gridData: FlGridData(drawVerticalLine: false, getDrawingHorizontalLine: (_) => FlLine(color: Colors.white.withValues(alpha: 0.05), strokeWidth: 1)),
      ...
      ...{...r1.biasResults.map((b) => b.columnName), ...r2.biasResults.map((b) => b.columnName)}.map((col) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(color: const Color(0xFF0D0D1A), borderRadius: BorderRadius.circular(10), border: Border.all(color: Colors.white.withValues(alpha: 0.07))),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: b2 <= b1 ? const Color(0xFF10B981).withValues(alpha: 0.1) : const Color(0xFFEF4444).withValues(alpha: 0.1),
            ...
            Row(children: [
              ...
              Expanded(child: ClipRRect(borderRadius: BorderRadius.circular(4), child: LinearProgressIndicator(value: b1, backgroundColor: Colors.white.withValues(alpha: 0.05), valueColor: const AlwaysStoppedAnimation(Color(0xFF6366F1)), minHeight: 6))),
              const SizedBox(width: 8),
            ...
            Row(children: [
              ...
              Expanded(child: ClipRRect(borderRadius: BorderRadius.circular(4), child: LinearProgressIndicator(value: b2, backgroundColor: Colors.white.withValues(alpha: 0.05), valueColor: const AlwaysStoppedAnimation(Color(0xFF8B5CF6)), minHeight: 6))),
              const SizedBox(width: 8),
